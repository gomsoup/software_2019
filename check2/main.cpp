...
auto model = face::createLBPHFaceRecognizer(1, 8, 8, 8, 300.0);
...
int trainData(){
    ...
    string txt = "python /root/checkserver/client.py " + to_string(result);
...
int switchCamera(string stdnum){
    studnumber = stdnum;
